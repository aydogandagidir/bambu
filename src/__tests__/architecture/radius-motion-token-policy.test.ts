...
const MOTION_BASELINE: Record<string, number> = {
  ...
  'admin/pages/dashboard/components/OnboardingPanel.module.css': 2,
  'admin/pages/dashboard/widgets/widgets.module.css': 1,
  ...
  'admin/pages/site/toolbar/Toolbar.module.css': 2,
  'admin/pages/site/ui/Tree/TreeRow.module.css': 2,
  'admin/shared/AccountMenuButton/AccountMenuButton.module.css': 1,
  ...
  'ui/components/DataTable/DataTable.module.css': 1,
  ...
  'ui/components/Tabs/Tabs.module.css': 1,
